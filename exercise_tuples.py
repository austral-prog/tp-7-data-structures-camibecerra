...
registro = ('Scrimshawed Whale Tooth', '2A')
print(get_coordinate(registro))
...
def create_record(registro_azara, registro_rui):
    ...
    """
    coordenada_azara = convert_coordinate(get_coordinate(registro_azara))
    coordenada_rui = get_coordinate(registro_rui)
